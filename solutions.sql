...
SELECT * FROM loan
WHERE loan_id = 6312; -- THIS IS THE LEAST PAYMENT AMOUNT
...
SELECT district_id, COUNT(client_id) as total_clients
FROM client
...
SELECT date, duration, COUNT(loan_id) as total_loan
FROM loan
...
SELECT 
    ...
    ELSE "Incoming" END as transaction_type, 
